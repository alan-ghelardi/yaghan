...
func RegisterClusterServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ClusterServiceServer) error {
	...
	mux.Handle("GET", pattern_ClusterService_GetNode_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/yaghan.control_plane.v1alpha1.ClusterService/GetNode", runtime.WithHTTPPathPattern("/v1alpha1/nodes/{node_id}"))
		if err != nil {
	...
	mux.Handle("GET", pattern_ClusterService_ListNodes_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/yaghan.control_plane.v1alpha1.ClusterService/ListNodes", runtime.WithHTTPPathPattern("/v1alpha1/nodes"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterClusterServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ClusterServiceClient) error {
	...
	mux.Handle("GET", pattern_ClusterService_GetNode_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/yaghan.control_plane.v1alpha1.ClusterService/GetNode", runtime.WithHTTPPathPattern("/v1alpha1/nodes/{node_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ClusterService_ListNodes_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/yaghan.control_plane.v1alpha1.ClusterService/ListNodes", runtime.WithHTTPPathPattern("/v1alpha1/nodes"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
