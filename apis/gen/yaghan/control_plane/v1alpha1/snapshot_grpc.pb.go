...
const (
	SnapshotService_CreateSnapshot_FullMethodName = "/yaghan.control_plane.v1alpha1.SnapshotService/CreateSnapshot"
	SnapshotService_GetSnapshot_FullMethodName    = "/yaghan.control_plane.v1alpha1.SnapshotService/GetSnapshot"
	SnapshotService_ListSnapshots_FullMethodName  = "/yaghan.control_plane.v1alpha1.SnapshotService/ListSnapshots"
	SnapshotService_DeleteSnapshot_FullMethodName = "/yaghan.control_plane.v1alpha1.SnapshotService/DeleteSnapshot"
)
...
var SnapshotService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "yaghan.control_plane.v1alpha1.SnapshotService",
	...
	Metadata: "yaghan/control_plane/v1alpha1/snapshot.proto",
}
