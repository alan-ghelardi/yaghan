---
title: nuinfra/control_plane/v1alpha1/cluster.proto version not set
language_tabs:
  - shell: cURL
  - python: Python
...
<h1 id="nuinfra-control_plane-v1alpha1-cluster-proto">nuinfra/control_plane/v1alpha1/cluster.proto version not set</h1>

> Scroll down for code samples, example requests and responses. Select a language for code samples from the tabs above or the mobile navigation menu.

<h1 id="nuinfra-control_plane-v1alpha1-cluster-proto-clusterservice">ClusterService</h1>
